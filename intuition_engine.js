  ...
  function compute(baseState) {
    ...
    const sub1 = subSkillStyled(
      ...
      [
        ...
        { name: "스파크형", raw: 1.0*el.water + 0.5*tg.인성 + 0.2*noise }
      ],
      0.45,
      [
    ...
    const sub2 = subSkillStyled(
      2, "미세신호 감지",
      [
        { name: "감각형", raw: 1.2*el.water + 0.6*el.wood + 0.3*tg.인성 + 0.2*noise },
    ...
    const sub4 = subSkillStyled(
      4, "판단 정밀도",
      [
        { name: "분석형", raw: 1.3*tg.인성 + 0.9*tg.식상 - 0.2*noise },
    ...
    const sub5 = subSkillStyled(
      5, "전략 설계력",
      [
        { name: "설계형", raw: 1.2*tg.관성 + 1.0*tg.인성 + 0.4*tg.식상 + 0.2*connect - 0.3*noise },
    ...
    const sub11 = subSkillStyled(
      11, "호감/거리감 감지",
      [
        { name: "분위기형", raw: 1.1*el.water + 0.7*el.wood + 0.2*noise },
    ...
    const sub12 = subSkillStyled(
      12, "분위기 흡수력",
      [
        { name: "수채형", raw: 1.2*el.water + 0.5*el.wood + 0.3*noise },
    ...
    const sub16 = subSkillStyled(
      16, "예감 적중률",
      [
        { name: "레이더형", raw: 1.2*tg.관성 + 0.5*el.water + 0.4*noise },
        { name: "상징형", raw: 1.1*tg.인성 + 0.6*el.water + 0.2*connect }
      ],
      0.50,
      [
    ...
    const sub17 = subSkillStyled(
      17, "직감 스파크",
      [
        { name: "스파크형", raw: 1.3*el.water + 0.4*noise + 0.2*tg.식상 },
        { name: "개념점프형", raw: 1.0*tg.인성 + 0.6*el.water + 0.2*tg.식상 }
      ],
      0.50,
      [
    ...
    const sub18 = subSkillStyled(
      18, "상징 해석력",
      [
        { name: "해석형", raw: 1.4*tg.인성 + 0.5*el.water + 0.2*tg.식상 },
        { name: "신호형", raw: 0.9*el.water + 0.5*noise + 0.3*connect }
      ],
      0.50,
      [
    ...
    const sub19 = subSkillStyled(
      19, "예지몽 체질",
      [
        { name: "몽형", raw: 1.4*el.water + 0.5*tg.인성 + 0.3*noise },
        { name: "민감형", raw: 1.0*el.water + 0.6*noise }
      ],
      0.50,
      [
    ...
    const sub20 = subSkillStyled(
      20, "신비 체감 민감도",
      [
        { name: "감응형", raw: 1.3*el.water + 0.5*noise + 0.2*el.wood },
        { name: "내면형", raw: 1.1*tg.인성 + 0.6*el.water + 0.2*connect }
      ],
      0.50,
      [
