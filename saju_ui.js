...
function renderDaeunScores(baseState, profileName = "overall") {
  ...
  decades.forEach((decade, idx) => {
    ...
    console.log(`${decade.stem}${decade.branch}: 종합${overall} 성과${performance}(raw:${_raw.rawPerformance}) 기반${support}(raw:${_raw.rawSupport}) 마찰${friction}(raw:${_raw.rawFriction}) (${g})`);
