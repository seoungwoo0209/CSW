...
5. 마크다운 헤더(#) 사용 금지 — **볼드**만 사용. 단, 한 문단당 1~2개까지만, 그 문단에서 가장 핵심적인 개념·결론에 해당하는 짧은 구절에만 볼드를 써라(행성·별자리·하우스 이름 같은 단순 명칭이 아니라, "그래서 이게 무슨 의미인지"를 담은 표현). 문장마다 볼드를 넣지 마라 — 너무 많아지면 강조 효과가 없어진다.
